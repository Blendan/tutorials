...
![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/2.PNG)


#### Then you applay all the Modifires and then go into the Edit-Mode and Remove all the Doubles.


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/3.PNG)


#### Then we select all the Verteces and Randmize.


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/4.PNG)


#### You can use diferent options.


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/5.PNG)

#### Then you deselect all the Verteces and then click on select Random.

![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/6.PNG)

![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/7.PNG)


#### How many you want to select is up to you.


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/8.PNG)


#### Then you delete the Verteces


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/9.PNG)


#### Then you add a Wireframe Modifire to the Mesh.
#### How bit you want it to be isup to you.

![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/10.PNG)


#### Then you go to a different Layer or just somewhere outside the camaras view and add a Ico Sphere.


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/11.PNG)
...
![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/12.PNG)

![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/13.PNG)


#### The World Background is set to White


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/14.PNG)


#### For the Net we set a Diffuse to Black.


![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/18.PNG)
...
![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/15.PNG)
...
![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/16.PNG)
...
![alt text](https://github.com/Blendan/tutorials/blob/master/Blender/3D_Netz/17.PNG)
